...
export interface ISubScenarioImageRepositoryPort {
  ...
  findBySubScenarioId(subScenarioId: number, includeHistorical?: boolean): Promise<SubScenarioImageDomainEntity[]>;
  findBySubScenarioIds(subScenarioIds: number[], includeHistorical?: boolean): Promise<SubScenarioImageDomainEntity[]>;
  ...
  markAsHistoricalByPosition(subScenarioId: number, isFeature: boolean, displayOrder: number): Promise<void>;
}
